        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-green-400 transition-colors text-sm">For Students</a></li>
              <li><a href="#" className="text-gray-400 hover:text-green-400 transition-colors text-sm">For Schools</a></li>
              <li><a href="#" className="text-gray-400 hover:text-green-400 transition-colors text-sm">Curriculum</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-green-400 transition-colors text-sm">FAQs</a></li>
            </ul>
          </div>
